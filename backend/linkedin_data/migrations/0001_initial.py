    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user_posted"], name="linkedin_da_user_po_be8340_idx"
                    ),
                    models.Index(
                        fields=["post_id"], name="linkedin_da_post_id_73fd15_idx"
                    ),
                    models.Index(
                        fields=["date_posted"], name="linkedin_da_date_po_3ff729_idx"
                    ),
                ],
