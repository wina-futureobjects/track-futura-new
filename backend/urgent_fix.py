#!/usr/bin/env python3
"""
🚨 URGENT PRODUCTION FIX - BACKEND VERSION
==========================================
Run this from the backend directory on your production server:

cd /app/backend && python urgent_fix.py

This will:
1. Link 78 scraped posts to job folders  
2. Update workflow statuses from pending to completed
3. Make data visible in frontend immediately
"""
...
if not os.path.exists('manage.py'):
    if os.path.exists('backend/manage.py'):
        ...
        print("❌ Error: Cannot find Django manage.py file")
