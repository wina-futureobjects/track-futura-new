    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user_posted"], name="tiktok_data_user_po_c08b58_idx"
                    ),
                    models.Index(
                        fields=["post_id"], name="tiktok_data_post_id_a42552_idx"
                    ),
                    models.Index(
                        fields=["date_posted"], name="tiktok_data_date_po_856caa_idx"
                    ),
                ],
