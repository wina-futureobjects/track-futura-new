"""
Production settings for TrackFutura project deployed on Render
"""
...
# Hosts and Origins for Render
ALLOWED_HOSTS = [
    '.onrender.com',
    'trackfutura-backend.onrender.com',
    'localhost',
    '127.0.0.1',
]
...
CSRF_TRUSTED_ORIGINS = [
    'https://*.onrender.com',
    'https://trackfutura-backend.onrender.com',
    'https://trackfutura-frontend.onrender.com',
]
...
# Add wildcard patterns for Render domains
