...
# Get the latest ScraperRequest
sr = ScraperRequest.objects.last()
if not sr:
    print("No ScraperRequest found in database")
    sys.exit(1)

print(f"ScraperRequest ID: {sr.id}")
...
print(f"Folder ID: {sr.shared_folder_id}")

print("\n" + "-" * 40)
print("RELATED BATCHSCRAPERJOB")
print("-" * 40)
...
print("\n" + "-" * 40)
print("RELATED UNIFIEDRUNFOLDER")
print("-" * 40)

if sr.shared_folder_id:
    try:
        folder = UnifiedRunFolder.objects.get(id=sr.shared_folder_id)
